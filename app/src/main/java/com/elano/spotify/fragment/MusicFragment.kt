package com.elano.spotify.fragment
...
import com.elano.spotify.MainActivity
...
class MusicFragment : Fragment(), View.OnClickListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, SeekBar.OnSeekBarChangeListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        mTvSongPlay.isSelected = true
        mTvSongPlay.text = ("${song.name} ${getString(R.string.text_bullet)} ${song.singer}")
